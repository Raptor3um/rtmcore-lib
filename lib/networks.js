 ...
 * numbers for each raptoreum network. Currently only supporting "livenet"
...
addNetwork({
  ...
  port: 8767,
  dnsSeeds: [
    'seed-raptor.raptoreum.org',
    'seed-raptor.bitactivate.com'
  ]
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'seed-testnet-raptor.raptoreum.org',
    'seed-testnet-raptor.bitactivate.com'
  ]
};
