...
var HDPrivateKey = rtmcore.HDPrivateKey;
var HDPublicKey = rtmcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = rtmcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(rtmcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(rtmcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      rtmcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = rtmcore.PublicKey.fromPoint;
      rtmcore.PublicKey.fromPoint = function() {
        rtmcore.PublicKey.fromPoint = unstubbed;
